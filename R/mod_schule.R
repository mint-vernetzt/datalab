...
#'
#' @noRd
mod_schule_server <- function(id, data_kurse, data_iqb_standard, data_iqb_score, r){

  r <- reactiveValues()

  # Kurse
  mod_schule_kurse_server("mod_schule_kurse_ui_1", data_kurse, data_iqb_standard, data_iqb_score, r)
