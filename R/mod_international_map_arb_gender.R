...
mod_international_map_arb_gender_ui <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(condition = "input.map_l_arb_gender == 'EU'",
                     ns = ns,
    ...
    conditionalPanel(condition = "input.map_l_arb_gender == 'OECD' ",
                     ...
                     conditionalPanel(condition = "input.map_pers_oecd_arb_gender == 'Anfänger*innen Ausbildung (ISCED 45)'|input.map_pers_oecd_arb_gender == 'Anfänger*innen Erstausbildung (ISCED 35)'|input.map_pers_oecd_arb_gender =='Absolvent*innen Ausbildung (ISCED 45)'|input.map_pers_oecd_arb_gender == 'Absolvent*innen Erstausbildung (ISCED 35)' ",
                                      ns = ns,
                     p("Jahr:"),
                     shinyWidgets::sliderTextInput(
                     ...
                     conditionalPanel(condition = "input.map_pers_oecd_arb_gender == 'Auszubildende (ISCED 45)'|input.map_pers_oecd_arb_gender == 'Auszubildende in Erstausbildung (ISCED 35)'|input.map_pers_oecd_arb_gender =='In Meisterlehre (< 880 Std. Vorbereitung, ISCED 55)'|input.map_pers_oecd_arb_gender == 'In Meister-/Technikerlehre (> 880 Std. Vorbereitung, ISCED 65)' ",
                                      ...
                                      p("Betrachtung:"),
                                      shinyWidgets::pickerInput(
                                        inputId = ns("map_betr_oecd_arb_gender"),
