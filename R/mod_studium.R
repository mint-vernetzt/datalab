...
#'
#' @noRd
mod_studium_server <- function(id, data_studierende, data_studierende_faecher, r){

  r <- reactiveValues()

  # Studienzahl
  mod_studium_studienzahl_server("mod_studium_studienzahl_ui_1", data_studierende, data_studierende_faecher, r)
