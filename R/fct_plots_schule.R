...
kurse_waffle_mint <- function(r) {
  ...
  if(betrachtung == "Einzelansicht - Kuchendiagramm"){
    ...
    df <-  df %>% dplyr::group_by(fachbereich, indikator) %>%
      dplyr::mutate(proportion = round(wert/props *100, 0),
    ...
    # plot
    out <- highcharter::hchart(df, 'bar', highcharter::hcaes(y = round(proportion), x = fachbereich))%>%
...
kurse_einstieg_comparison <- function(r) {
 ...
 out <-  highcharter::hchart(df1, 'bar', highcharter::hcaes(y = round(proportion), x = indikator, group = forcats::fct_rev(fachbereich))) %>%
    ...
    df1$proportion <- round(df1$proportion, 0)
    ...
    out <- df1 %>%
      ...
      highcharter::hc_title(text = paste0("MINT-Anteil in ", titel_help,  " in ", regio, " (", timerange, ")"),
                            margin = 45,
                            align = "center",
                            style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
      highcharter::hc_chart(
...
kurse_verlauf_single <- function(r) {
  ...
  if(absolut_selector == "In Prozent"){
   ...
   df <- df[with(df, order(jahr, decreasing = FALSE)), ]
    ...
    # plot
    out <- highcharter::hchart(df, 'line', highcharter::hcaes(x = jahr, y = round(prop), group = indikator)) %>%
      ...
      highcharter::hc_title(text = paste0("Anteil von MINT-Belegungen an allen Belegungen in ", regio),
                            margin = 45,
                            align = "center",
                            style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
    ...
    out <- highcharter::hchart(df, 'line', highcharter::hcaes(x = jahr, y = round(wert), group = indikator)) %>%
      ...
      highcharter::hc_xAxis(title = list(text = "Jahr"), allowDecimals = FALSE, style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular")) %>%
      #highcharter::hc_caption(text = "Quelle: ",  style = list(fontSize = "12px") ) %>%
      highcharter::hc_title(text = paste0("Anzahl an MINT-Belegungen in der Schule in ", regio),
                            margin = 45,
                            align = "center",
                            style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
      highcharter::hc_colors(c("#b16fab", "#154194","#66cbaf")) %>%
...
kurse_mint_map <- function(r) {
  ...
  if(betrachtung == "Zeitverlauf - Liniendiagramm"){
    ...
    if(absolut_selector=="In Prozent"){
      ...
      # plot
      out <- highcharter::hchart(df, 'line', highcharter::hcaes(x = jahr, y = round(wert), group = region)) %>%
...
kurse_map <- function(r) {
  ...
  if(betrachtung == "Übersicht - Kartendiagramm"){
   ...
   # df <- order(df$wert, decreasing = TRUE)
    #Plot
    out <- highcharter::hchart(df, 'bar', highcharter::hcaes(y = round(proportion), x = region)) %>%
  ...
  if(absolut_selector=="In Prozent"){
    ...
    out <- highcharter::hchart(df, 'line', highcharter::hcaes(x = jahr, y = round(wert), group = fachbereich)) %>%
      ...
      highcharter::hc_title(text = paste0("Anteil einzelner Fächer an den ", kurs_help ," in ", states),
                            ...
                            align = "center",
                            style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
      highcharter::hc_colors(as.character(df$color)) %>% #c("#b16fab", "#154194","#66cbaf", "#fbbf24", "#8893a7", "#ee7775", "#9d7265", "#35bd97", "#d0a9cd",
...
kurse_comparison_gender <- function(r) {
  ...
  if(betrachtung == "Einzelansicht - Kuchendiagramm"){
    ...
    if(gegenwert == "Ja"){
      ...
      mint <- df_mint %>%
        highcharter::hchart(
          "pie", size = 280, mapping = highcharter::hcaes(x = anzeige_geschlecht , y = round(proportion))
        )%>%
        highcharter::hc_tooltip(
          pointFormat=paste('Anteil: {point.proportion}% <br> Anzahl: {point.wert}')) %>%
      ...
      rest <- df_rest %>%
        highcharter::hchart(
          "pie", size = 150, mapping = highcharter::hcaes(x = anzeige_geschlecht , y = proportion)
        )%>%
        highcharter::hc_tooltip(
          pointFormat=paste('Anteil: {point.proportion}% <br> Anzahl: {point.wert}')) %>%
        highcharter::hc_colors(c("#154194" ,"#efe8e6")) %>%
        highcharter::hc_title(text = paste0("Mädchen-Anteil in anderen ", titel_help,  " in ", regio, " (", timerange, ")"),
                              margin = 45,
                              align = "center",
                              style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
        highcharter::hc_chart(
      ...
      out <- df1 %>%
        highcharter::hchart(
          "pie", highcharter::hcaes(x = anzeige_geschlecht , y = round(proportion))
        )%>%
        highcharter::hc_tooltip(
          pointFormat=paste('Anteil: {point.proportion}% <br> Anzahl: {point.wert}')) %>%
        highcharter::hc_colors(c("#154194" ,"#efe8e6")) %>%
    ...
    if(gegenwert == "Ja"){
      ...
      out <- highcharter::hchart(df1, 'bar', highcharter::hcaes( x = indikator, y=round(proportion), group = anzeige_geschlecht)) %>%
...
kurse_wahl <- function(r) {
  ...
  if(betrachtung == "Einzelansicht - Kuchendiagramm"){
    ...
    df <- df %>% dplyr::group_by(fachbereich, indikator, anzeige_geschlecht) %>%
      dplyr::mutate(proportion = round(wert/props *100))
    ...
    if(vergleich == "Ja"){
      ...
      frauen <- df_f %>%
        highcharter::hchart(
          "pie", size = 280, mapping = highcharter::hcaes(x = fachbereich , y = round(proportion))
        )%>%
        highcharter::hc_tooltip(
          pointFormat=paste('Anteil: {point.proportion}% <br> Anzahl: {point.wert}')) %>%
        highcharter::hc_colors(as.character(df_f$col)) %>%
        highcharter::hc_title(text = paste0(titel_help, " von Mädchen in ", regio, " (", timerange, ")"),
                              margin = 45,
                              align = "center",
                              style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
        highcharter::hc_chart(
      ...
      männer <- df_m %>%
        highcharter::hchart(
          "pie", size = 150, mapping = highcharter::hcaes(x = fachbereich , y = proportion)
        )%>%
        highcharter::hc_tooltip(
          pointFormat=paste('Anteil: {point.proportion}% <br> Anzahl: {point.wert}')) %>%
        highcharter::hc_colors(as.character(df_m$col)) %>%
        highcharter::hc_title(text = paste0(titel_help, " von Jungen in ", regio, " (", timerange, ")"),
                              margin = 45,
                              align = "center",
                              style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
        highcharter::hc_chart(
...
iqb_standard_zeitverlauf <- function(r){
  ...
  out <- highcharter::hchart(df, 'column', highcharter::hcaes(y = wert, x = region, group=jahr))%>%
    ...
    highcharter::hc_title(text = paste0("Anteil der Schüler:innen aus ", title_help, ", die den Mindeststandard in Mathematik nicht erreichen"),
                          margin = 45,
                          align = "center",
                          style = list(color = "black", useHTML = TRUE, fontFamily = "SourceSans3-Regular", fontSize = "20px")) %>%
    highcharter::hc_chart(
...
iqb_fragebogen <- function(r){
  ...
  # plot
  out <- highcharter::hchart(df, 'column', highcharter::hcaes(y = round(wert, 2), x = indikator, group = geschlecht))%>%
    highcharter::hc_plotOptions(column = list(pointWidth = 90))%>%
