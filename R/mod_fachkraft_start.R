    ...
    div(class = "content-box",
       ...
       bis 2037 1,4 Mio. MINT-Fachkräfte zusätzlich gewonnen werden. Im Vergleich dazu bewegen wir
        uns aktuell auf rund 100.000 MINT-Fachkräfte weniger zu, in einem Worst Case sogar auf rund 1,1 Mio. weniger."),
              br(), br(),
              tags$a(href = "https://www.mint-vernetzt.de/content/uploads/2026/01/MINTvernetzt_Kurzanalyse_Zukunftsszenarien_MINT-Fachkraefte.pdf", target = "_blank",
              ...
              tags$a(href = "https://www.mint-vernetzt.de/content/uploads/2026/01/MINTvernetzt_Kurzanalyse_Zukunftsszenarien_Zuwanderung_MINT.pdf", target = "_blank",
...
div(class = "content-box",
    div(class = "inner-box",
        ...
        p(style = "font-size = 24",
          ...
          br(), br(),
          tags$a(href = "https://www.mint-vernetzt.de/content/uploads/2026/01/MINTvernetzt_Kurzanalyse_Fachkraeftemangel_MINT-Disziplinen.pdf", target = "_blank",
