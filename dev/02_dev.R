...
golem::add_module(name = "fachkraft_top_bottom", with_test = FALSE)
golem::add_module(name = "fachkraft_item_prog", with_test = FALSE)
golem::add_module(name = "fachkraft_item_prog_detail", with_test = FALSE)
golem::add_module(name = "fachkraft_wirkhebel_analyse", with_test = FALSE)
